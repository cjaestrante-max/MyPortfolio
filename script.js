...
=======
let isAdmin = false;
>>>>>>> 3bdde9f1f53f44b0eca42b72641539362bcd5fcd
let currentType = "";
let currentExam = "";
...
let laboratories = JSON.parse(localStorage.getItem("laboratories")) || defaultLaboratories;
...
let pdfBtn = "";
if (type === "LABORATORY" && item.pdfUrl) {
pdfBtn = `
<div style="margin-top: 12px;">
<a href="${item.pdfUrl}" target="_blank" class="button" style="padding: 6px 12px; font-size: 12px; display: inline-block; background: #222; color: #fff; border-radius: 4px; text-decoration: none;" onclick="event.stopPropagation();">
Open Laboratory PDF ↗
</a>
</div>
`;
...
let pdfContainer = document.getElementById("detailPdfContainer");
if (type === "LABORATORY" && item.pdfUrl) {
pdfContainer.style.display = "block";
pdfContainer.innerHTML = `<b>PDF File:</b> <a href="${item.pdfUrl}" target="_blank" style="color: #007bff; text-decoration: underline;">View Attached PDF ↗</a>`;
} else {
