...
let defaultQuizzes = [
    ...
    },
    {
        ...
        date: "2026-08-31",
        score: "19/20",
        description: "Quiz 2 assessment for Cloud Computing.",
    ...
    },
    {
        ...
        date: "2026-09-07",
        score: "20/20",
        description: "Quiz 3 assessment for Cloud Computing.",
    ...
    },
    {
        ...
        date: "2026-09-14",
        score: "37/40",
        description: "Long Quiz assessment covering initial modules.",
        image: "images/longquiz.png"
    }
];

let defaultLaboratories = [
    {
        id: 101,
    ...
    Prelims: [
        {
            ...
            date: "2026-09-23",
            score: "86",
            description: "Prelims Examination Output",
            image: "images/prelims.png"
        }
    ],
...
let quizzes =
    JSON.parse(localStorage.getItem("quizzes")) || defaultQuizzes;

let laboratories =
    JSON.parse(localStorage.getItem("laboratories")) || defaultLaboratories;

let savedExams = JSON.parse(localStorage.getItem("exams"));

let exams = savedExams || defaultExams;
...
function addAdminCard(list, type) {
    ...
    card.innerHTML = `
        ...
        <p>
            ${type === "quiz"
                ? "Add your quiz output here."
                : "Add your laboratory output here."}
        </p>
    `;
...
function addOutput() {
    ...
    if (
        ...
        alert(
            "Please complete the title, course, date and score."
        );
...
function renderQuizzes() {
    ...
    if (quizzes.length === 0) {
        ...
        empty.innerText =
            "There are no quiz activities added yet.";
...
function renderLaboratories() {
    ...
    if (laboratories.length === 0) {
        ...
        empty.innerText =
            "There are no laboratory activities added yet.";
    ...
    if (outputs.length === 0) {
        ...
        list.innerHTML = `
            ...
            <div class="empty-message">
                ...
                There are no
                ${currentExam.toLowerCase()}
                exam outputs added yet.
